...
void AtlasEngine::_drawGlyph(const AtlasQueueItem& item) const
{
    ...
    const f32x2 layoutBox{ cells * _r.cellSizeDIP.x, _r.cellSizeDIP.y };
    ...
    else
    {
        ...
        // * Whitespace is an "empty" glyph:
        //     left:   -10.0f
        //     right:  -10.0f
        //     top:     -0.0f
        //     bottom: -20.0f
        //   Just for the following glyph, left and right are identical.
        //   This happens because we asked for DWRITE_TEXT_ALIGNMENT_CENTER.
        //   --> offsetX = 0
        //   --> offsetY = 0
        //   --> scale   = 1
    ...
    for (u32 i = 0; i < cells; ++i)
    {
        ...
        if (scalingRequired)
        {
            // TODO: This scaling causes the glyphs to slightly shift around by a pixel
            // We'll have to investigate how to prevent such rounding errors with D2D.
            // One option would be to use an intermediate render target via
            // ID2D1RenderTarget::CreateCompatibleRenderTarget and upload glyphs tile-wise.
            // debugGlyphGenerationPerformance can be used for performance tests.
